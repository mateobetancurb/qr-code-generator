...
export const es: Translation = {
	...
	generator: {
		...
		image: "Imagen o logo (opcional)",
		imageHint: "PNG, JPEG o WebP de hasta 2 MB",
		selectImage: "Elegir imagen",
		replaceImage: "Reemplazar imagen",
		removeImage: "Eliminar imagen",
		imageSize: "Tamaño de imagen",
		imageRadius: "Redondez de esquinas",
		imageBackground: "Fondo detrás de la imagen",
		imageBackgroundColor: "Color de fondo de la imagen",
		imageBackgroundHex: "Color hexadecimal del fondo de la imagen",
		imageTypeError: "Elige una imagen PNG, JPEG o WebP.",
		imageSizeError: "Elige una imagen de menos de 2 MB.",
		imageDecodeError: "No se pudo abrir esta imagen. Prueba con otro archivo.",
