...
export const es: Translation = {
	...
	hero: {
		...
		headlineLine1: "Crea tu",
		headlineLine2: "código QR al instante",
		subtext:
		...
		cards: [
			{
				...
				title: "Ultrarrápido",
				description:
					"Genera códigos QR al instante con vista previa en tiempo real. Sin esperas ni demoras",
			},
			{
				id: 2,
				title: "Colores personalizados",
				description: "Personaliza tus códigos QR con colores de primer plano y de fondo a tu gusto",
			},
			{
				id: 3,
				title: "Varios formatos",
				description: "Descarga tus códigos QR en PNG o SVG para cualquier caso de uso",
			},
			{
				id: 4,
				title: "Privacidad primero",
				description:
					"Todos los códigos QR se generan localmente en tu navegador. Tus datos no salen de tu dispositivo",
			},
			{
				id: 5,
				title: "Ideal para móviles",
				description:
					"Diseño totalmente adaptable que funciona perfectamente en escritorio, tablet y móvil",
			},
			{
				id: 6,
				title: "Sin registro",
				description: "Empieza a generar códigos QR de inmediato. Sin cuenta y completamente gratis",
			},
		],
	},
	footer: {
